...
const file_api_notes_v1_note_service_proto_rawDesc = "" +
	"\n" +
	"\x1fapi/notes/v1/note_service.proto\x12\bnotes.v1\x1a#api/google/protobuf/timestamp.proto\x1a\x1fapi/google/protobuf/empty.proto\x1a\x1eapi/common/v1/pagination.proto\x1a api/google/api/annotations.proto\"C\n" +
	"\x11CreateNoteRequest\x12\x14\n" +
	"\x05title\x18\x01 \x01(\tR\x05title\x12\x18\n" +
	"\acontent\x18\x02 \x01(\tR\acontent\")\n" +
	"\x0eGetNoteRequest\x12\x17\n" +
	"\anote_id\x18\x01 \x01(\tR\x06noteId\"P\n" +
...
var file_api_notes_v1_note_service_proto_depIdxs = []int32{
	8,  // 0: notes.v1.ListNotesRequest.pagination:type_name -> common.v1.PaginationRequest
	6,  // 1: notes.v1.ListNotesResponse.notes:type_name -> notes.v1.Note
	9,  // 2: notes.v1.ListNotesResponse.pagination:type_name -> common.v1.PaginationResponse
	10, // 3: notes.v1.Note.created_at:type_name -> google.protobuf.Timestamp
	10, // 4: notes.v1.Note.updated_at:type_name -> google.protobuf.Timestamp
	6,  // 5: notes.v1.NoteResponse.note:type_name -> notes.v1.Note
	0,  // 6: notes.v1.NoteService.CreateNote:input_type -> notes.v1.CreateNoteRequest
	1,  // 7: notes.v1.NoteService.GetNote:input_type -> notes.v1.GetNoteRequest
	2,  // 8: notes.v1.NoteService.ListNotes:input_type -> notes.v1.ListNotesRequest
	4,  // 9: notes.v1.NoteService.UpdateNote:input_type -> notes.v1.UpdateNoteRequest
	5,  // 10: notes.v1.NoteService.DeleteNote:input_type -> notes.v1.DeleteNoteRequest
	7,  // 11: notes.v1.NoteService.CreateNote:output_type -> notes.v1.NoteResponse
	7,  // 12: notes.v1.NoteService.GetNote:output_type -> notes.v1.NoteResponse
	3,  // 13: notes.v1.NoteService.ListNotes:output_type -> notes.v1.ListNotesResponse
	7,  // 14: notes.v1.NoteService.UpdateNote:output_type -> notes.v1.NoteResponse
	11, // 15: notes.v1.NoteService.DeleteNote:output_type -> google.protobuf.Empty
