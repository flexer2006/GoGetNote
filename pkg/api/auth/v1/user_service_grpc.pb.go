...
func (c *userServiceClient) GetUserProfile(ctx context.Context, in *emptypb.Empty, opts ...grpc.CallOption) (*UserProfileResponse, error) {
...
func (UnimplementedUserServiceServer) GetUserProfile(context.Context, *emptypb.Empty) (*UserProfileResponse, error) {
