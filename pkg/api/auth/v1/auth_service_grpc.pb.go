...
const (
	...
	AuthService_GetAuthError_FullMethodName  = "/auth.v1.AuthService/GetAuthError"
)
...
type AuthServiceClient interface {
	...
	GetAuthError(ctx context.Context, in *GetAuthErrorRequest, opts ...grpc.CallOption) (*v1.ErrorResponse, error)
}
...
func (c *authServiceClient) GetAuthError(ctx context.Context, in *GetAuthErrorRequest, opts ...grpc.CallOption) (*v1.ErrorResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(v1.ErrorResponse)
	err := c.cc.Invoke(ctx, AuthService_GetAuthError_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type AuthServiceServer interface {
	...
	// GetAuthError возвращает стандартизированную ошибку аутентификации
	GetAuthError(context.Context, *GetAuthErrorRequest) (*v1.ErrorResponse, error)
...
func (UnimplementedAuthServiceServer) GetAuthError(context.Context, *GetAuthErrorRequest) (*v1.ErrorResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method GetAuthError not implemented")
}
...
func _AuthService_GetAuthError_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(GetAuthErrorRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(AuthServiceServer).GetAuthError(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: AuthService_GetAuthError_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(AuthServiceServer).GetAuthError(ctx, req.(*GetAuthErrorRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var AuthService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "GetAuthError",
			Handler:    _AuthService_GetAuthError_Handler,
		},
	},
