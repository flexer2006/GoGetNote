// Package app реализует бизнес-логику аутентификации и управления пользователями,
// предоставляя сервисы для регистрации, аутентификации и работы с пользовательскими профилями.
package app
